#ifndef GRAPH_TRANSITIVE_REDUCTION
#define GRAPH_TRANSITIVE_REDUCTION
...
class GraphTransitiveReduction{
...
private:
	...
	std::ifstream inputContainmentGraphFile;
...
public:
	...
	GraphTransitiveReduction(char * inputcontainmentFilename, char * outputContainmentFilename);
	GraphTransitiveReduction();
	~GraphTransitiveReduction();
	/**
